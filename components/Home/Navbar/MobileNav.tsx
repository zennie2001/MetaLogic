...
const MobileNav = ({closeNav, showNav}:Props) => {
  ...
  return (
    <div>
        ...
        {/* Navlinks */}
        <div className={`text-white ${navOpen} fixed justify-center flex flex-col h-full transform transition-all duration-500  w-[80%] sm:w-[60%] bg-rose-800 space-y-6 z-[1050]`}>
            {navLinks.map((link)=>{
                return (
